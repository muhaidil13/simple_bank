...
func TestTransferTx(t *testing.T) {
	...
	for i := 0; i < n; i++ {
		...
		require.Equal(t, account2.ID, toEntry.AccountID) // Fixed: Should be account2
		...
		fmt.Println(">> Process TX:", fromAccount.Balance, toAccount.Balance)
	...
	fmt.Println(">> Afer:", updatedAccount1.Balance, updatedAccount2.Balance)
